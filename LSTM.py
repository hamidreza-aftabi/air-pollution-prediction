...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Train and Validation Loss of LSTM Network')
plt.legend()
...
plt.title('True VS Predicted Value for Test Data of LSTM Network')
...
plt.title('True and Predicted Value for Test Data of LSTM Network')
plt.xlabel('Times')
plt.ylabel('Values')
plt.legend()
